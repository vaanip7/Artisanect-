...
/**
 * About
 * Static informational page describing Artisanect's mission of
 * connecting artisans with technology and customers.
 *
 * @returns {JSX.Element}
 */
function About() {
    ...
    <>
      ...
      <main className="flex-1 bg-paper dark:bg-ink transition-colors duration-300">
        <section className="max-w-4xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
          ...
          <h1 className="font-display font-bold text-3xl sm:text-4xl text-ink dark:text-paper mt-2 mb-6">
            About Artisanect
          </h1>

          <div className="h-1 w-24 bg-clay rounded-full mb-8"></div>

          <p className="text-base sm:text-lg text-ink/75 dark:text-paper/75 leading-relaxed max-w-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
            <div className="bg-white dark:bg-ink-light border border-ink/10 dark:border-paper/10 rounded-xl p-6 transition-colors duration-300">
              <h3 className="font-display font-semibold text-ink dark:text-paper mb-2">For Artisans</h3>
            ...
            <div className="bg-white dark:bg-ink-light border border-ink/10 dark:border-paper/10 rounded-xl p-6 transition-colors duration-300">
              <h3 className="font-display font-semibold text-ink dark:text-paper mb-2">For Customers</h3>
              <p className="text-sm text-ink/65 dark:text-paper/65">
                Discover authentic, handmade products with verified artisan stories behind them.
              </p>
            </div>
            <div className="bg-white dark:bg-ink-light border border-ink/10 dark:border-paper/10 rounded-xl p-6 transition-colors duration-300">
              <h3 className="font-display font-semibold text-ink dark:text-paper mb-2">Powered by AI</h3>
              <p className="text-sm text-ink/65 dark:text-paper/65">
